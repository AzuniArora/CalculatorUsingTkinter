...
def sqr():
    global oprator
    store=int(textvalue.get())
    result=math.factorial(store)
    print(result)
...
#divide=Button(root,text="n!", padx=15, bd=5,fg="black", bg="#fecd53",font="arial 20 bold",command=sqr).grid(row=5,column=3)
